...
INSERT INTO [UserProfile]
    ([Id], [Name], [FirebaseUserId], [Email], [DateCreated], [ImageUrl])
VALUES
    (1, 'Groucho', 'HevT3yVnxFUVnCK1Yjj1u7ycrro2', 'groucho@marx.com', SYSDATETIME(), NULL),
    (2, 'Harpo', 'ZZQSmi6oPxb6xJT2NeODD7nSCGk1', 'harpo@marx.com', SYSDATETIME(), NULL),
    (3, 'Chico', 'MLEj4ojIfhaTUuZn4gnwYTs5j6F3', 'chico@marx.com', SYSDATETIME(), NULL);
